...
#define FOE_FILEDOWNLOAD_PASSWORD 0x11223344
/*--------------------------------------------------------------------------------------
------
------    local types and defines
------
--------------------------------------------------------------------------------------*/
#define    MAX_FILE_NAME_SIZE    0x16

/** \brief  MAX_FILE_SIZE: Maximum file size */
#define MAX_FILE_SIZE	0x80000	// SAME54 Bank A/B Size
#define MAX_BLOCK_SIZE  0x2000	// SAME54 Block Size
/*-----------------------------------------------------------------------------------------
------
